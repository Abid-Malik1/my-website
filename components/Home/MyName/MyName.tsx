...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a <span className="text-AAsecondary">Web & Mobile Developer</span>, i possess strong problem-solving skills and
        specialize in hybrid App development using Flutter. <br className="2xl:block hidden" />
