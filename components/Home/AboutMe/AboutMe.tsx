...
export default function AboutMe(props) {
  const technologies = [
    ["Next.js", "JavaScript", "Tailwind CSS", "HTML5", "CSS", "Blockchain", "React"],
    ["Node.js", "TypeScript", "Flutter", "Dart", "Python", "Solidity", "React Native"],
  ];
  return (
    <div
      id="aboutSection"
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! I am Abid Malik, Bachelor of Computer Science. I am a
                Flutter developer with having 3 years of Experience in Flutter
                Development. I can build hybrid apps with Flutter. Development
                is my passion. I love to take on new endeavors and deliver the
                best results. I accept every project as a challenge to improve
                myself and grow my skills.
              </span>
            </div>
            {/* <div className="font-Header ">
              <span className="text-gray-400 ">
          ...
          <div className="group relative lg:w-96 lg:h-96 md:w-72 md:h-72 md:block hidden ">
            ...
            <div className="absolute w-5/6 h-5/6  rounded overflow-hidden">
              ...
              <Img
                src={"/img/Portfolio-portrait.png"}
